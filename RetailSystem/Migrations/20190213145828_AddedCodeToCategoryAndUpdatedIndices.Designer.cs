...
namespace RetailSystem.Migrations
{
    ...
    [Migration("20190213145828_AddedCodeToCategoryAndUpdatedIndices")]
    partial class AddedCodeToCategoryAndUpdatedIndices
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RetailSystem.Models.AppUser", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("RetailSystem.Models.Category", b =>
                {
                    ...
                    b.HasIndex("BusinessId", "Code")
                        .IsUnique()
                        .HasName("Business_Category_Code")
                        .HasFilter("[Code] IS NOT NULL");

                    b.HasIndex("BusinessId", "Name")
                        .IsUnique()
                        .HasName("Business_Category_Name");
            ...
            modelBuilder.Entity("RetailSystem.Models.Item", b =>
                {
                    ...
                    b.HasAlternateKey("CategoryId", "Code")
                        .HasName("Category_Item_Code");
                    ...
                    b.HasIndex("CategoryId", "Description")
                        .HasName("Category_Item_Description");
            ...
            modelBuilder.Entity("RetailSystem.Models.Location", b =>
                {
                    ...
                    b.HasIndex("BusinessId", "Name")
                        .IsUnique()
                        .HasName("Business_Location_Name");
            ...
            modelBuilder.Entity("RetailSystem.Models.Manufacturer", b =>
                {
                    ...
                    b.HasIndex("BusinessId", "Name")
                        .IsUnique()
                        .HasName("Business_Manufacturer_Name");
            ...
            modelBuilder.Entity("RetailSystem.Models.Sale", b =>
                {
                    ...
                    b.HasIndex("LocationId", "ReferenceNumber")
                        .IsUnique()
                        .HasName("Location_Sale_ReferenceNumber");
            ...
            modelBuilder.Entity("RetailSystem.Models.Supplier", b =>
                {
                    ...
                    b.HasIndex("BusinessId", "Name")
                        .IsUnique()
                        .HasName("Business_Supplier_Name");

                    b.HasIndex("BusinessId", "SupplierNumber")
                        .IsUnique()
                        .HasName("Business_Supplier_Number");
            ...
            modelBuilder.Entity("RetailSystem.Models.Supply", b =>
                {
                    ...
                    b.HasIndex("LocationId", "ReferenceNumber")
                        .IsUnique()
                        .HasName("Location_Supply_ReferenceNumber")
            ...
            modelBuilder.Entity("RetailSystem.Models.Transfer", b =>
                {
                    ...
                    b.HasIndex("SourceLocationId", "DestinationLocationId", "TransferNumber")
                        .IsUnique()
                        .HasName("Location_Transfer_Number");
